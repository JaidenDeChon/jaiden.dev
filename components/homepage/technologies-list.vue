        ...
        <div class="size-for-all-screens">
            ...
            <div class="mt-6 flex flex-wrap justify-center gap-3 sm:gap-6">
                <div
                    ...
                    :key="technology.name"
                    class="technology-card p-4 grow-0 basis-[calc((100%_-_0.75rem)/2)] h-32 flex items-center justify-center flex-col gap-2 border-2 border-brand-blue/20 rounded-md bg-brand-blue/20 bg-clip-padding transition-colors sm:basis-[calc((100%_-_1.5rem)/2)] md:basis-[calc((100%_-_3rem)/3)] md:h-52 md:gap-4 lg:basis-[calc((100%_-_4.5rem)/4)]"
                    :style="{ '--glow-color': technology.iconColor }"
                >
                    <Icon
                        :name="technology.icon"
                        size="3em"
                        :style="{ color: technology.iconColor }"
                        class="relative backlight"
                        :data-glow="technology.iconColor"
                    />
                    <p class="afacad w-full text-center text-lg font-medium">
                        {{ technology.name }}
                    </p>
